...
/*! \fun void cuStenCompute2DXYpFun
...
template
__global__ void kernel2DXYpFun<double>
(
	double*,  				
	double*,					
	double*, 				
...
template
void cuStenCompute2DXYpFun<double>
(
	cuSten_t<double>*,
	bool
);
...
template
__global__ void kernel2DXYpFun<float>
(
	float*,  				
	float*,					
	float*, 				
...
template
void cuStenCompute2DXYpFun<float>
(
	cuSten_t<float>*,
	bool
);

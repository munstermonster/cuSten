...
/*! \file 2d_x_p_fun_kernel.cu
    Functions to apply a periodic user function to a 2D domain, x-direction only.
*/
...
/*! \fun static __global__ void kernel2DXpFun

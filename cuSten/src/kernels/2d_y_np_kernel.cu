...
/*! \fun __global__ void kernel2DYnp
...
template
__global__ void kernel2DYnp<double>
(
	double*,  					
	double*,					
	double*, 				
...
template
void cuStenCompute2DYnp<double>
(
	cuSten_t<double>*,
	bool
);
...
template
__global__ void kernel2DYnp<float>
(
	float*,  					
	float*,					
	float*, 				

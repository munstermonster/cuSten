...
template
void cuStenCreate2DXpFun<double>(
	cuSten_t<double>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXpFun<double>(
	cuSten_t<double>*,
	double*
);

template
void cuStenDestroy2DXpFun<double>(
	cuSten_t<double>*
);

template
void cuStenCreate2DXpFun<float>(
	cuSten_t<float>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXpFun<float>(
	cuSten_t<float>*,
	float*
);

template
void cuStenDestroy2DXpFun<float>(
	cuSten_t<float>*
);

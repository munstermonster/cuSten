...
template
void cuStenCreate2DXYnp<double>(
	cuSten_t<double>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXYnp<double>(
	cuSten_t<double>*,
	double*
);

template
void cuStenDestroy2DXYnp<double>(
	cuSten_t<double>*
);

template
void cuStenCreate2DXYnp<float>(
	cuSten_t<float>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXYnp<float>(
	cuSten_t<float>*,
	float*
);

template
void cuStenDestroy2DXYnp<float>(
	cuSten_t<float>*
);

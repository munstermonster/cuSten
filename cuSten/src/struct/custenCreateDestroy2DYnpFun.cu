...
template
void cuStenCreate2DYnpFun<double>(
	cuSten_t<double>*,		
	int,				
	int,				
	int,				
...
template
void cuStenSwap2DYnpFun<double>(
	cuSten_t<double>*,
	double*
);

template
void cuStenDestroy2DYnpFun<double>(
	cuSten_t<double>*
);

template
void cuStenCreate2DYnpFun<float>(
	cuSten_t<float>*,		
	int,				
	int,				
	int,				
...
template
void cuStenSwap2DYnpFun<float>(
	cuSten_t<float>*,
	float*
);

template
void cuStenDestroy2DYnpFun<float>(
	cuSten_t<float>*
);

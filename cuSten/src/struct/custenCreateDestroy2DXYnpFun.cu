...
template
void cuStenCreate2DXYnpFun<double>(
	cuSten_t<double>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXYnpFun<double>(
	cuSten_t<double>*,
	double*
);

template
void cuStenDestroy2DXYnpFun<double>(
	cuSten_t<double>*
);

template
void cuStenCreate2DXYnpFun<float>(
	cuSten_t<float>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXYnpFun<float>(
	cuSten_t<float>*,
	float*
);

template
void cuStenDestroy2DXYnpFun<float>(
	cuSten_t<float>*
);

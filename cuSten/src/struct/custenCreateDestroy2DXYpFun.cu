...
/*! \file custenCreateDestroy2DXYpFun.cu
...
template
void cuStenCreate2DXYpFun<double>(
	cuSten_t<double>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXYpFun<double>(
	cuSten_t<double>*,
	double*
);

template
void cuStenDestroy2DXYpFun<double>(
	cuSten_t<double>*
);

template
void cuStenCreate2DXYpFun<float>(
	cuSten_t<float>*,
	int,
	int,
	int,
...
template
void cuStenSwap2DXYpFun<float>(
	cuSten_t<float>*,
	float*
);

template
void cuStenDestroy2DXYpFun<float>(
	cuSten_t<float>*
);
